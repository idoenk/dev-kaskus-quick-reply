...
(function(){
  ...
  gvar.sversion = 'v' + '1.0';
  gvar.scriptMeta = {
    timestamp: 1356904133845 // version.timestamp
  ...
  */
  ...
  var rSRC = {
    ...
    getCSS: function(){
      ...
      +'.mQR .in-txt #'+gvar.tID+'{height:90px; min-height:50px; min-width:590px; max-width:590px;}'
      ...
      /* night-mode */
      +'body.nightmode .mQR .in-txt input[type="text"], .mQR .in-txt #'+gvar.tID+'{color:#f0f0f0;}'

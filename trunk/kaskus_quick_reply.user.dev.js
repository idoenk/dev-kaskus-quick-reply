...
// -!--latestupdate
//
// v3.2.6 - 2011-09-27 . 1317074018822
...
gvar.scriptMeta = {
  timestamp: 1317074018822 // version.timestamp
...
function do_click_qr(e){
  ...
  var snapTo=function(){
	...
	ss.smoothScroll( Dom.g(gvar.id_textarea), function(){ snapTo_cb() });
  };
  snapTo();
